...
export interface ApiLogoLogo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Black: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    White: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
  };
}
...
export interface ApiSectionMainSectionMain extends Struct.SingleTypeSchema {
  collectionName: 'section_mains';
  info: {
    description: '';
    displayName: 'Section_main';
    pluralName: 'section-mains';
    singularName: 'section-main';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Header_link: Schema.Attribute.Component<'header.header-links', true>;
    Header_post: Schema.Attribute.Component<'header.header-posts', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSectionYourSectionYour extends Struct.SingleTypeSchema {
  collectionName: 'section_yours';
  info: {
    description: '';
    displayName: 'Section_your';
    pluralName: 'section-yours';
    singularName: 'section-your';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiSitySity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::sity.sity'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiUiConfigUiConfig extends Struct.SingleTypeSchema {
  collectionName: 'ui_configs';
  info: {
    displayName: 'UI_Config';
    pluralName: 'ui-configs';
    singularName: 'ui-config';
  };
  options: {
    draftAndPublish: false;
  };
